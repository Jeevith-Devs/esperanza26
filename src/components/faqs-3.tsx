        ...
        <section ref={sectionRef} className="bg-black py-12 sm:py-16 md:py-20 lg:py-32 relative overflow-hidden">
            ...
            <div className="mx-auto max-w-full sm:max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl px-4 sm:px-6 md:px-8 lg:px-12 relative z-10">
                ...
                <motion.h2
                    ...
                    className="text-center text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black tracking-tight bg-gradient-to-b from-white via-[#C0C0C0] to-purple-500 bg-clip-text text-transparent mix-blend-screen drop-shadow-[0_0_30px_rgba(255,255,255,0.15)] uppercase font-bricolage mb-3 sm:mb-4 leading-tight">
