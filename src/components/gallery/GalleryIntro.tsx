    ...
    <section className="relative h-[70vh] flex flex-col items-center justify-center overflow-hidden w-full">
      <div className="flex flex-col items-center justify-center z-10 px-4 w-full">
        <motion.h1
          ...
          className="text-[20vw] md:text-[15vw] lg:text-[180px] font-black tracking-tighter leading-none text-center select-none uppercase font-bricolage bg-gradient-to-b from-white via-[#C0C0C0] to-purple-500 bg-clip-text text-transparent mix-blend-screen drop-shadow-[0_0_30px_rgba(255,255,255,0.15)] px-2"
