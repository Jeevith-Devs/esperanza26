...
const DecryptLink = ({ href, text, onClick, index }: { href: string; text: string; onClick: () => void; index: number }) => {
    ...
    return (
        ...
        >
            <span
                className={`text-3xl sm:text-4xl font-black font-bricolage tracking-tighter uppercase text-center transition-all duration-300 ${isScrambling ? 'text-white/50 blur-[1px]' : 'bg-gradient-to-b from-white via-[#C0C0C0] to-purple-500 bg-clip-text text-transparent mix-blend-screen drop-shadow-[0_0_30px_rgba(255,255,255,0.15)] group-hover:scale-110'}`}
                            ...
                            >
                                ...
                                <div className="flex flex-col items-center gap-4 text-center">
                                    <div className="flex flex-col items-center">
                                        ...
                                        <span className="text-lg font-bold font-bricolage bg-gradient-to-b from-white via-[#C0C0C0] to-purple-500 bg-clip-text text-transparent mix-blend-screen drop-shadow-[0_0_30px_rgba(255,255,255,0.15)]">MARCH 6, 2026</span>
                                    </div>
