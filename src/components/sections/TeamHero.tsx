...
export default function TeamHero() {
  return (
    <div className="relative w-full min-h-[50vh] md:h-[75vh] flex items-center justify-center overflow-hidden mb-8 md:mb-12 py-10 md:py-0">
      ...
      >
        <h1
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-tight font-bricolage bg-gradient-to-b from-white via-[#C0C0C0] to-purple-500 bg-clip-text text-transparent mix-blend-screen drop-shadow-[0_0_30px_rgba(255,255,255,0.15)]"
          style={{
