...
const HeroSection: React.FC = () => {
    ...
    const videos = [
        "/assets/intro%20videos/intro1.mp4",
        "/assets/intro%20videos/intro2.mp4",
    ];
            ...
            <div id="video-frame" className="relative z-10 h-dvh w-full overflow-hidden">
                <div className="relative h-full w-full">
                    ...
                    <div className="sm:hidden absolute inset-0 z-30 flex flex-col items-center justify-center gap-0 px-4 pointer-events-none">
                        ...
                        <h1
                            className="font-black uppercase text-[4rem] leading-[0.85] tracking-tighter text-center bg-gradient-to-b from-white via-[#C0C0C0] to-purple-500 bg-clip-text text-transparent mix-blend-screen drop-shadow-[0_0_30px_rgba(255,255,255,0.15)] -mb-1 relative z-0"
                            style={{
                        ...
                        <h2
                            className="font-black text-[7rem] leading-[0.8] tracking-tighter text-center bg-gradient-to-b from-white via-[#C0C0C0] to-purple-500 bg-clip-text text-transparent mix-blend-screen drop-shadow-[0_0_30px_rgba(255,255,255,0.15)] -mt-12 relative z-20"
                            style={{
                                fontFamily: "var(--font-bricolage)",
