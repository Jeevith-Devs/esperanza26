    ...
    <div className="my-8 min-h-screen w-full overflow-hidden bg-background" id="sponsors">
      ...
      <section ref={sectionRef} className="pb-[1rem] pt-[4rem] md:pt-[7rem] px-2">
        <motion.h2
          ...
          className="bg-gradient-to-b from-white via-[#C0C0C0] to-purple-500 bg-clip-text text-transparent mix-blend-screen drop-shadow-[0_0_30px_rgba(255,255,255,0.15)] flex justify-center text-center font-bricolage text-2xl md:text-4xl lg:text-5xl font-black mb-8 md:mb-8 tracking-tighter"
        ...
        >
          <h3 className="text-sm md:text-xl lg:text-3xl font-black tracking-tight mb-4 md:mb-8 bg-gradient-to-b from-white to-[#C0C0C0] bg-clip-text text-transparent mix-blend-screen drop-shadow-[0_0_30px_rgba(255,255,255,0.15)]">TITLE SPONSOR</h3>
          <motion.div
        ...
        <section ref={sponsorsRef} className="flex flex-col justify-around lg:flex-row lg:gap-8 mt-8 md:mt-12">
          {[
            ...
            >
              <h4 className="pb-2 md:pb-4 text-xs md:text-lg lg:text-2xl font-black tracking-tight bg-gradient-to-b from-white to-[#C0C0C0] bg-clip-text text-transparent mix-blend-screen drop-shadow-[0_0_30px_rgba(255,255,255,0.15)]">{sponsor.title}</h4>
              <motion.div
        ...
        >
          <h4 className="text-xs md:text-lg lg:text-2xl font-black tracking-tight opacity-80 bg-gradient-to-b from-white to-[#C0C0C0] bg-clip-text text-transparent mix-blend-screen drop-shadow-[0_0_30px_rgba(255,255,255,0.15)]">OTHER SPONSORS</h4>
        </motion.section>
      </section>
    </div>
  );
