    ...
    <section ref={sectionRef} className="bg-black w-full overflow-hidden">
      <div className="mx-auto max-w-[1600px] px-4 sm:px-6 md:px-12 lg:px-24 py-8 sm:py-12 md:py-16">
        <div className="mb-4 sm:mb-6 md:mb-10">
          ...
          >
            <span
              className="block text-[12vw] lg:text-[120px] font-black tracking-tight leading-none text-left select-none bg-gradient-to-b from-white via-[#C0C0C0] to-purple-500 bg-clip-text text-transparent mix-blend-screen drop-shadow-[0_0_30px_rgba(255,255,255,0.15)] uppercase font-bricolage px-2"
