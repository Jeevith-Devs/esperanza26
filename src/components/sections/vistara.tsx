    ...
    <section ref={sectionRef} className="relative overflow-hidden bg-[#050505] py-16 md:py-24">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="mt-24 relative flex flex-col items-center justify-center [perspective:1000px]">
          ...
          >
            <h3 className="text-lg md:text-xl font-bold tracking-[0.2em] mb-2 uppercase font-bricolage bg-gradient-to-b from-white via-[#C0C0C0] to-purple-500 bg-clip-text text-transparent mix-blend-screen drop-shadow-[0_0_30px_rgba(255,255,255,0.15)]">Guess Who is Coming?</h3>
